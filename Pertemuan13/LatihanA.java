...
public class LatihanA extends JFrame{
    JButton btnAdd, btnSubtract, btnDivide, btnMultiply, btnClear, btnDelete, btnEquals,
            btnDot;
    JButton numBtn[];
    JTextField output;
    ...
    public LatihanA() {
        ...
        output.setDisabledTextColor(new Color(255, 4, 4));
